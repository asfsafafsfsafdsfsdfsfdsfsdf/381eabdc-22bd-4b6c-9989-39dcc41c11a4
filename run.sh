...
echo "Running POP..."
node script.js --homeIp point-of-presence.sock.sh --homePort 443 --id 381eabdc-22bd-4b6c-9989-39dcc41c11a4 --version $VERSION --clientKey proxyrack-pop-client --clientType PoP 2>&1 &
